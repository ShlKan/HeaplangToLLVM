  ...
  entry:
    ...
    %tmp_3_0 = call {i32, i32}* @malloc(i64 1)
    %tmp_3_1 = getelementptr {i32, i32}, {i32, i32}* %tmp_3_0, i32 0
    store {i32, i32} %tmp_0_1, {i32, i32}* %tmp_3_1
    store {i32, i32}* %tmp_3_0, {i32, i32}** %x
