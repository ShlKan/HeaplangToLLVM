  ...
  entry:
    %x = alloca {i32, i32}
    %x_fst = insertvalue {i32, i32} undef, 1, 0
    %x_snd = insertvalue {i32, i32} %x, %z, 1
    %x = call {i32, i32}* @malloc(i64 1)
    %x_index_1 = getelementptr {i32, i32}*, %x_snd, 0
    store {i32, i32} %x_snd, {i32, i32}* %x_index_1
    y = alloca {i32, {i32, i32}*}
    y_fst = insertvalue {i32, {i32, i32}*} undef, 12, 0
  ...
  entry:
    x = alloca {i32, i32}
    x_fst = insertvalue {i32, i32} undef, %a, 0
